    ...
    <div className="Home">
      <section id="home">
        <div class="scroll-container">
          <img 
            src={require("../Photos/parliament.jpg")} 
            alt="parliament" 
            width="400" 
            height="400"
          />
          <img 
            id="tajMahal"
            src={require("../Photos/tajMahal.jpg")} 
            alt="tajMahal" 
            width="700" 
            height="400"
          />
          <img 
            src={require("../Photos/holi.jpg")} 
            alt="holi" 
            width="600" 
            height="400"
          />
          <img 
            src={require("../Photos/courtPillars.jpg")} 
            alt="courtPillars" 
            width="400" 
            height="400"
          />
          <img 
            src={require("../Photos/elephantStatue.jpg")} 
            alt="elephantStatue" 
            width="300" 
            height="400"
          />
          <img 
            src={require("../Photos/peacock.jpg")} 
            alt="parliament" 
            width="300" 
            height="400"
          />
          <img 
            src={require("../Photos/train.jpg")} 
            alt="parliament"
            width="600" 
            height="400"
          />
          <img 
            src={require("../Photos/rickshaw.jpg")} 
            alt="parliament" 
            width="400" 
            height="400"
          />
          <img 
            src={require("../Photos/sadhus.jpg")} 
            alt="parliament" 
            width="600" 
            height="400"
          />
          <img 
            src={require("../Photos/dance.jpg")} 
            alt="parliament" 
            width="700" 
            height="400"
          />
          <img 
            src={require("../Photos/ghat.jpg")} 
            alt="parliament" 
            width="400" 
            height="400"
          />
          <img 
            src={require("../Photos/camel.jpg")} 
            alt="parliament" 
            width="600" 
            height="400"
          />
          <img 
            src={require("../Photos/street.jpg")} 
            alt="parliament" 
            width="300" 
            height="400"
          />
          <img 
            src={require("../Photos/waterCarrier.jpg")} 
            alt="parliament" 
            width="300" 
            height="400"
          />
          <img 
            src={require("../Photos/elephant.jpg")} 
            alt="parliament" 
            width="700" 
            height="400"
          />
          <img 
            src={require("../Photos/jaipur.jpg")} 
            alt="parliament" 
            width="400" 
            height="400"
          />
          <img 
            src={require("../Photos/goldenTemple.jpg")} 
            alt="parliament" 
            width="400" 
            height="400"
          />
          <img 
            src={require("../Photos/ornament.jpg")} 
            alt="parliament" 
            width="600" 
            height="400"
          />
